		...
		<div class="container">
			<div class="row jewel-grids-main-in">
				...
				<div class="col-lg-4 bottom-sub-grid text-center" data-aos="fade-up">
					...
					<h4 class="sub-tittle">37%</h4>
					<p>Reduction in return rates</p>
				</div>
				<!-- /.col-lg-4 -->
			</div>
		</div>
	...
	<section class="banner-bottom-w3ls-agileinfo">
		...
		<div class="portfolio" id="portfolio">
			<div class="container">
                ...
                <button class="" ><a href="#">All</a></button>
                <button class=""><a href="rings.php">Rings</a></button>
                <button class=""><a href="neckles.php">Neckles</a></button>
                <button class=""><a href="earrings.php">Ear Rings</a></button>
                <button class=""><a href="watches.php">Watches</a></button>
					...
					<!--<ul class="portfolio-categ filter text-center mb-lg-5 mb-3">
						...
						<li class="cat-item-1">
							<a href="add.php" title="Category 1">Rings</a>
						</li>
						<li class="cat-item-2">
							<a href="#" title="Category 2">Necklace</a>
						</li>
						<li class="cat-item-3">
							<a href="#" title="Category 3">Ear Rings</a>
						</li>
						<li class="cat-item-4">
							<a href="#" title="Category 4">Watches</a>
						</li>
					</ul>-->
						...
						<li class="portfolio-item2" data-id="id-0" data-type="cat-item-4">
							<div>
								<span class="image-block img-hover">
									<a class="image-zoom rounded" href="images/2.jfif" data-gal="prettyPhoto[gallery]">
			
										<img src="images/2.jfif" class="img-fluid rounded" alt="">
